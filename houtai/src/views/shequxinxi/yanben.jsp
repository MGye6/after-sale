<template>
	<div>
		<el-form :inline="true" :model="formInline" class="user-search">
			<el-form-item label=""><el-input size="small" v-model="formInline.wangdianmingcheng" placeholder="输入网点名称"></el-input></el-form-item>			<el-form-item label=""><el-input size="small" v-model="formInline.wangdianlianxifangshi" placeholder="输入网点联系方式"></el-input></el-form-item>			<el-form-item label=""><el-input size="small" v-model="formInline.wangdianleixing" placeholder="输入网点类型"></el-input></el-form-item>			
			<el-form-item>
...
import { shequxinxiList, shequxinxiSave, shequxinxiDelete,shequxinxiEdit,shequxinxiDeleteList } from '@/api/shequxinxi/shequxinxiApi';
