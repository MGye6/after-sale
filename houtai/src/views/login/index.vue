<template>
	<div>
		<div class="login-logo"><h1>{{ getThemeConfig.globalTitle }}</h1></div>
		<div class="login-box">
			<el-form name="form1" :model="ruleForm" :rules="rules" ref="ruleForm">
				<div class="content hide" style="display: block;">
					...
					<div class="formRow" :visible.sync="editFormVisible">
