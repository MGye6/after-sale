    ...
    <div class="order-content">
      <div class="content">
        <el-form :inline="true" :model="formInline" class="user-search">
          ...
          <el-form-item styxlexulxie6 prop="leixingmingcheng">
        ...
        <ul>
          ...
          <li class="header">
            <div class='pro-img'> 网点编号</div>
            <div class='pro-img'> 网点名称</div>
            <div class='pro-img'> 网点位置</div>
            <div class='pro-img'> 网点联系方式</div>
            <div class='pro-img'> 店面图片</div>


          </li>

          <li class="product-list" v-for="item in wangdianxinxi" :key="item.id">
            <router-link :to="`/wangdianxinxidetail/`+item.id">
              <div class='pro-img'>{{ item.wangdianbianhao }}</div>
              ...
              <div class='pro-img'>{{ item.dianmiantupian }}</div>
...
export default {
  ...
  methods: {
    ...
    search() {
      this.getwangdianxinxi(this.formInline)
    },
    // 向后端请求分类列表数据
    getwangdianxinxi(parameter) {
      this.$axios
          .post("/api/front/wangdianxinxi", {...parameter})
          .then(res => {
            debugger
            this.wangdianxinxi = res.data.data.list;
