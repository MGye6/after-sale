<template>
  ...
  <table width="100%" border="0"  align="center" cellpadding="3" cellspacing="1" class="newsline">
								<tr>
        <td width='22%' height=44>网点编号：</td><td width='39%' >{{wangdianxinxidetail.wangdianbianhao}}</td></tr><tr>         <td width='22%' height=44>网点名称：</td><td width='39%' >{{wangdianxinxidetail.wangdianmingcheng}}</td></tr><tr>         <td width='22%' height=44>网点位置：</td><td width='39%' >{{wangdianxinxidetail.wangdianweizhi}}</td></tr><tr>         <td width='22%' height=44>网点联系方式：</td><td width='39%' >{{wangdianxinxidetail.wangdianlianxifangshi}}</td></tr><tr>                  <td width='22%' height=44>类型名称：</td><td width='39%' >{{wangdianxinxidetail.leixingmingcheng}}</td></tr><tr>         
</table>
        <div class="button">
		  <!--dshoucang1-->
